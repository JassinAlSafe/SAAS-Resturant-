...
var createProductParameters = (_context = {}) => z.object({
  name: z.string().describe("The name of the product."),
  description: z.string().optional().describe("The description of the product.")
});
var listProductsParameters = (_context = {}) => z.object({
  limit: z.number().int().min(1).max(100).optional().describe(
    "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10."
  )
});
var createPriceParameters = (_context = {}) => z.object({
...
var listPricesParameters = (_context = {}) => z.object({
  product: z.string().optional().describe("The ID of the product to list prices for."),
  limit: z.number().int().min(1).max(100).optional().describe(
    "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10."
  )
});
var createPaymentLinkParameters = (_context = {}) => z.object({
...
var listInvoicesParameters = (context = {}) => {
  const schema = z.object({
    customer: z.string().optional().describe("The ID of the customer to list invoices for."),
    limit: z.number().int().min(1).max(100).optional().describe(
      "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10."
    )
  });
...
var finalizeInvoiceParameters = (_context = {}) => z.object({
  invoice: z.string().describe("The ID of the invoice to finalize.")
});
var retrieveBalanceParameters = (_context = {}) => z.object({});
var createRefundParameters = (_context = {}) => z.object({
  payment_intent: z.string().describe("The ID of the PaymentIntent to refund."),
  amount: z.number().int().optional().describe("The amount to refund in cents.")
});
var listPaymentIntentsParameters = (context = {}) => {
  const schema = z.object({
    customer: z.string().optional().describe("The ID of the customer to list payment intents for."),
    limit: z.number().int().min(1).max(100).optional().describe(
      "A limit on the number of objects to be returned. Limit can range between 1 and 100."
    )
  });
...
var searchDocumentationParameters = (_context = {}) => z.object({
  question: z.string().describe(
    "The user question about integrating with Stripe will be used to search the documentation."
  ),
  language: z.enum(["dotnet", "go", "java", "node", "php", "ruby", "python", "curl"]).optional().describe(
