...
const AlertDialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-center sm:text-left modal-header",
      className
    )}
    {...props}
  />
...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 modal-action",
      className
    )}
    {...props}
  />
