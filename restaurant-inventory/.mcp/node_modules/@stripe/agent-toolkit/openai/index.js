...
var createProductParameters = (_context = {}) => import_zod.z.object({
...
var listProductsParameters = (_context = {}) => import_zod.z.object({
  limit: import_zod.z.number().int().min(1).max(100).optional().describe(
    "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10."
  )
});
var createPriceParameters = (_context = {}) => import_zod.z.object({
...
var listPricesParameters = (_context = {}) => import_zod.z.object({
  product: import_zod.z.string().optional().describe("The ID of the product to list prices for."),
  limit: import_zod.z.number().int().min(1).max(100).optional().describe(
    "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10."
  )
});
var createPaymentLinkParameters = (_context = {}) => import_zod.z.object({
...
var listInvoicesParameters = (context = {}) => {
  const schema = import_zod.z.object({
    customer: import_zod.z.string().optional().describe("The ID of the customer to list invoices for."),
    limit: import_zod.z.number().int().min(1).max(100).optional().describe(
      "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10."
    )
  });
...
var finalizeInvoiceParameters = (_context = {}) => import_zod.z.object({
  invoice: import_zod.z.string().describe("The ID of the invoice to finalize.")
});
var retrieveBalanceParameters = (_context = {}) => import_zod.z.object({});
var createRefundParameters = (_context = {}) => import_zod.z.object({
  payment_intent: import_zod.z.string().describe("The ID of the PaymentIntent to refund."),
  amount: import_zod.z.number().int().optional().describe("The amount to refund in cents.")
});
var listPaymentIntentsParameters = (context = {}) => {
  const schema = import_zod.z.object({
    customer: import_zod.z.string().optional().describe("The ID of the customer to list payment intents for."),
    limit: import_zod.z.number().int().min(1).max(100).optional().describe(
      "A limit on the number of objects to be returned. Limit can range between 1 and 100."
    )
  });
...
var searchDocumentationParameters = (_context = {}) => import_zod.z.object({
  ...
  language: import_zod.z.enum(["dotnet", "go", "java", "node", "php", "ruby", "python", "curl"]).optional().describe(
