...
export default function SupplierLoading() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      <div className="mb-8">
        <div className="bg-white rounded-xl border shadow-xs overflow-hidden p-4">
        ...
        <div className="bg-white rounded-xl border shadow-xs overflow-hidden">
          <div className="p-5">
            <div className="space-y-6">
              <div className="bg-linear-to-r from-gray-50 to-slate-50 p-4 flex items-center gap-2 border-b border-gray-100">
